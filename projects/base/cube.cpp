...
GLuint Cube::getBoundingBoxVao() const {
    return _boxVao;
}

size_t Cube::getVertexCount() const {
    return _vertices.size();
}

size_t Cube::getFaceCount() const {
    return _indices.size() / 3;
}

void Cube::initGLResources() {
