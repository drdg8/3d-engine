...
Sphere::Sphere(const std::vector<Vertex>& vertices, const std::vector<uint32_t>& indices)
...
GLuint Sphere::getBoundingBoxVao() const {
    return _boxVao;
}
...
size_t Sphere::getFaceCount() const {
    return _indices.size() / 3;
}

void Sphere::initGLResources() {
...
void Sphere::initBoxGLResources() {
